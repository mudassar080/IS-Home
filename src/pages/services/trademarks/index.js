              ...
              <div className="col-md-8 ml-auto mr-auto">
                ...
                <ol className="counting-list text-[#999] pt-5 text-[17px] font-light max-[640px]:pl-[15px]">
                  <li>
                    ...
                    We conduct an exhaustive search of the United States Patent
                    and Trademark Office (USPTO) database, uncovering any
                    federally registered trademarks that may pose a conflict.
                  </li>
                  <li>
                    <span className="font-medium">State Database Search: </span>
                    We go beyond federal registrations, scouring state databases
                    to identify any trademarks that may hinder your application
                    at the state level.
                  </li>
                  <li>
                    <span className="font-medium">Common Law Search: </span> We
                    explore the realm of unregistered trademarks, ensuring that
                    your brand name is clear of any common law conflicts that
                    could arise from long-term use by others.
                  </li>
                  <li>
                    <span className="font-medium">Domain Name Search: </span> We
                    investigate the availability of your desired domain name,
                    helping you secure a cohesive online presence for your
                    brand.
                  </li>
                </ol>
                <TextBlock>
                ...
                <ol className="counting-list text-[#999] pt-5 text-[17px] font-light max-[640px]:pl-[15px]">
                  <li>
                    ...
                    filing of your federal trademark application, ensuring that
                    it meets all USPTO requirements.
                  </li>
                  <li>
                    <span className="font-medium">
                  ...
                  <li>
                    <span className="font-medium">Continuous Updates: </span> We
                    keep you informed of your application's progress, providing
                    regular status updates from the USPTO.
                  </li>
                  <li>
